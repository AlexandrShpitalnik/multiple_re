...
parser.add_argument('--initial_ckpt', default=None,
        help='Pre-trained ckpt path for continual training')
...
if args.initial_ckpt:
    framework.load_state_dict(torch.load(args.initial_ckpt)['state_dict'])
