...
class BERTEntityEncoder(nn.Module):
    def __init__(self, max_length, pretrain_path, blank_padding=True, mask_entity=False, hidden_size=768):
        """
        Args:
            max_length: max length of sentence
            pretrain_path: path of pretrain model
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(pretrain_path)#BertTokenizer.from_pretrained(pretrain_path)
