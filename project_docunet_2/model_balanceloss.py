...
class DocREModelUnet(nn.Module):
    ...
    def encode(self, input_ids, attention_mask, entity_pos, noise_flag, noise_add_fraq, tokens_mask, add_noise_type):
        config = self.config
    ...
    def forward(self,
        ...
        sequence_output, attention = self.encode(input_ids, attention_mask, entity_pos, noise_flag,
                                                 noise_add_fraq, tokens_mask, add_noise_type)
